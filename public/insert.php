<?php
    ...
    $nameError = $descriptionError = $logementError = $categoryError = $imageError = $name = $description = $logement = $piece = $image = "";

    if(!empty($_POST)) 
    {
        $name               = checkInput($_POST['name']);
        $description        = checkInput($_POST['description']);
        $price              = checkInput($_POST['logement']);
        $category           = checkInput($_POST['piece']); 
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare("INSERT INTO items (name,description,logement,piece,image) values(?, ?, ?, ?, ?)");
            $statement->execute(array($name,$description,$logement,$piece,$image));
            Database::disconnect();
